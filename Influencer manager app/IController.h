...
public:
    ...
    virtual std::string closeCampaign(const std::string& brand) = 0;
    virtual std::string concludeAppContract(const std::string& userName) = 0;
    virtual void applicationReportCommand() = 0;
