...
public:
    ...
    virtual std::string closeCampaign(const std::string& brand) override;
    virtual std::string concludeAppContract(const std::string& userName) override;
    virtual void applicationReportCommand() override;
};
